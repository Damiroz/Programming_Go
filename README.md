# Практическое занятие №10 — Горизонтальное масштабирование: Load Balancer (NGINX). Ибраимов Дамир ПИМО-01-25
...
## Шаг 8. Проверка балансировки и Проверка передачи заголовков через NGINX
